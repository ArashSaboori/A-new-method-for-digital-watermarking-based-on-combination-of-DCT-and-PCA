...
close all
clear
watermarked_image= imread('YUV_watermarked.bmp');
%watermarked_image= imread('YUV_watermarked.jpg');
imshow(watermarked_image);
watermarked_image=RGB2YUV(watermarked_image);
watermarked_image=watermarked_image(:,:,1);

orginal_image = imread('lena_rgb.bmp');
%orginal_image = imread('peppers_rgb.png');
%orginal_image = imread('goldhill_rgb.png');
orginal_image=imresize(orginal_image, [512 512]);
orginal_image=RGB2YUV(orginal_image);
orginal_image=orginal_image(:,:,1);
