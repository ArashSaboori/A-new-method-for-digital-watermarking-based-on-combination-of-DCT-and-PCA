...
cover_image1=RGB2YUV(cover_image);
...
%%********************Compressed*********************************************
%imwrite(watermarked_image,'YUV_watermarked.jpg','Quality',30);
%watermarked_image=imread('YUV_watermarked.jpg');
%% **********************noise*********************************************
...
%% ****************************************************************************
imwrite(watermarked_image,'YUV_watermarked.bmp','bmp');
