...
A(:,:,1)=R;
A(:,:,2)=G;
A(:,:,3)=watermarked_image;
watermarked_image=A;
%%*********************************************************************************
%% ************************** Attack  *****************************************

%%********************Compressed*********************************************
%imwrite(watermarked_image,'RGB_watermarked.jpg','Quality',30);
%watermarked_image=imread('RGB_watermarked.jpg');
%% **********************noise*********************************************
...
%% ****************************************************************************
imwrite(watermarked_image,'RGB_watermarked.bmp','bmp');
