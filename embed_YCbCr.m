...
%cover_image= imread('peppers_gray.png');
%cover_image= imread('goldhill_gray.png');
cover_image=imresize(cover_image, [512 512]);
figure
imshow(cover_image);

cover_image1=rgb2ycbcr(cover_image);
cover_image=cover_image1(:,:,1)
Cb=cover_image1(:,:,2)
Cr=cover_image1(:,:,3)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
message_image = imread('IEEE_binary.bmp');
...
A(:,:,1)=watermarked_image;
A(:,:,2)=Cb;
A(:,:,3)=Cr;
watermarked_image=ycbcr2rgb(A);

%%*********************************************************************************
%% ************************** Attack  *****************************************

%%********************Compressed*********************************************
%imwrite(watermarked_image,'YCbCr_watermarked.jpg','Quality',30);
%watermarked_image=imread('YCbCr_watermarked.jpg');
%% **********************noise*********************************************
...
%% ****************************************************************************
imwrite(watermarked_image,'YCbCr_watermarked.bmp','bmp');
